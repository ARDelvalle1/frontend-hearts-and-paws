  ...
  return (
    <div className="min-h-screen bg-[#fff8f5] dark:bg-[#121214] text-[#1c1c21] dark:text-[#ffede4] font-body-editorial flex flex-col selection:bg-[#c85a32] selection:text-white">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <main className="flex-1 min-w-0 w-full">
            <div className="flex flex-col gap-6">
              {/* Panel de Filtros */}
              <div className="bg-white dark:bg-[#1c1c21] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl p-5 shadow-xs flex flex-col sm:flex-row flex-wrap items-center gap-3">
                <input
                  type="text"
                  placeholder="Filtrar por nombre..."
                  value={filtroNombre}
                  onChange={(e) => setFiltroNombre(e.target.value)}
                  className="w-full sm:w-52 px-5 py-2 border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20 bg-[#fff8f5] dark:bg-[#121214] text-[#6c2f00] dark:text-[#ffdbc9] placeholder:text-[#54433a]/60 dark:placeholder:text-[#dac2b6]/60 font-body-editorial text-sm font-semibold rounded-full shadow-xs focus:outline-none focus:ring-2 focus:ring-[#6c2f00] transition-all"
                />
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto ml-auto">
                  ...
                  <button
                    ...
                    className="border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20 text-[#6c2f00] dark:text-[#ffdbc9] hover:bg-[#ffeade] dark:hover:bg-[#26262e] font-body-editorial text-xs font-semibold px-5 py-2.5 rounded-full transition-all cursor-pointer flex-1 sm:flex-initial flex items-center justify-center gap-1.5"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {organizaciones.map((org) => (
                <div
                  ...
                  className="bg-white dark:bg-[#1c1c21] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl p-6 shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer group flex flex-col justify-between"
                >
      ...
      {organizacionSeleccionada && (
        <div className="fixed inset-0 bg-[#1c1c21]/60 dark:bg-black/70 backdrop-blur-xs z-50 flex items-center justify-center p-4 transition-opacity">
          <div className="bg-white dark:bg-[#1c1c21] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-3xl p-8 max-w-md w-full shadow-2xl relative font-body-editorial">
            <button

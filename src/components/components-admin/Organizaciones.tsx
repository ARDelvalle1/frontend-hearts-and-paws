  ...
  return (
    <div className="min-h-screen bg-[#fff8f5] dark:bg-[#1a0f08] text-[#28180d] dark:text-[#ffede4] font-body-editorial flex flex-col selection:bg-[#c85a32] selection:text-white">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <aside className="w-full md:w-64 shrink-0 space-y-4 sticky top-6 font-body-editorial">
            ...
            <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl p-5 shadow-xs text-center">
              <p className="font-body-editorial text-xs font-bold uppercase tracking-wider text-[#54433a] dark:text-[#dac2b6] mb-1 flex items-center justify-center gap-1.5">
                <span className="material-symbols-outlined text-lg text-[#6c2f00] dark:text-[#ffdbc9]">verified</span>
                Total Aprobadas
              </p>
          ...
          <main className="flex-1 min-w-0 w-full">
            <div className="flex flex-col gap-6">
              {/* Panel de Filtros */}
              <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl p-5 shadow-xs flex flex-col sm:flex-row flex-wrap items-center gap-3">
                <input
                  type="text"
                  placeholder="Filtrar por nombre..."
                  value={filtroNombre}
                  onChange={(e) => setFiltroNombre(e.target.value)}
                  className="w-full sm:w-52 px-5 py-2 border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20 bg-[#fff8f5] dark:bg-[#1a0f08] text-[#6c2f00] dark:text-[#ffdbc9] placeholder:text-[#54433a]/60 dark:placeholder:text-[#dac2b6]/60 font-body-editorial text-sm font-semibold rounded-full shadow-xs focus:outline-none focus:ring-2 focus:ring-[#6c2f00] transition-all"
                />
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto ml-auto">
                  ...
                  <button
                    ...
                    className="border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20 text-[#6c2f00] dark:text-[#ffdbc9] hover:bg-[#ffeade] dark:hover:bg-[#3f2c20] font-body-editorial text-xs font-semibold px-5 py-2.5 rounded-full transition-all cursor-pointer flex-1 sm:flex-initial flex items-center justify-center gap-1.5"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {organizaciones.map((org) => (
                <div
                  ...
                  className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl p-6 shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer group flex flex-col justify-between"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-display-editorial text-lg font-bold text-[#6c2f00] dark:text-[#ffdbc9] group-hover:text-[#c85a32] transition-colors truncate">
                        {org.nombre}
                      </h3>
                  ...
                  <div className="mt-5 pt-3 border-t border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 flex items-center justify-between font-body-editorial text-xs text-[#54433a] dark:text-[#dac2b6]">
                    <span className="flex items-center gap-1">
                      <span className="material-symbols-outlined text-xs text-[#6c2f00] dark:text-[#ffdbc9]">calendar_month</span>
                      {new Date(org.creado_en).toLocaleDateString("es-AR")}
                    </span>
                    <span className="font-semibold text-[#6c2f00] dark:text-[#ffdbc9] group-hover:text-[#c85a32] transition-colors flex items-center gap-0.5">
                      Ver más
      ...
      {organizacionSeleccionada && (
        <div className="fixed inset-0 bg-[#28180d]/60 dark:bg-black/70 backdrop-blur-xs z-50 flex items-center justify-center p-4 transition-opacity">
          <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-3xl p-8 max-w-md w-full shadow-2xl relative font-body-editorial">
            <button
            ...
            <h2 className="font-display-editorial text-2xl font-bold text-[#6c2f00] dark:text-[#ffdbc9] text-center mb-6">
            ...
            <div className="space-y-3 text-sm text-[#54433a] dark:text-[#dac2b6] bg-[#fff8f5] dark:bg-[#1a0f08] p-5 rounded-2xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10">
              <p className="flex items-center gap-2">
                ...
                <strong className="text-[#6c2f00] dark:text-[#ffdbc9]">Email:</strong> {organizacionSeleccionada.email}
              </p>
              <p className="flex items-center gap-2">
                <span className="material-symbols-outlined text-base text-[#6c2f00] dark:text-[#ffdbc9]">workspace_premium</span>
                <strong className="text-[#6c2f00] dark:text-[#ffdbc9]">Plan:</strong> {organizacionSeleccionada.plan}
              </p>
              <p className="flex items-center gap-2">
                <span className="material-symbols-outlined text-base text-[#6c2f00] dark:text-[#ffdbc9]">calendar_month</span>
                <strong className="text-[#6c2f00] dark:text-[#ffdbc9]">Fecha de Registro:</strong>{" "}

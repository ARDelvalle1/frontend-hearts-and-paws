    ...
    <div className="min-h-screen bg-[#fff8f5] dark:bg-[#1a0f08] text-[#28180d] dark:text-[#ffede4] font-body-editorial flex flex-col selection:bg-[#c85a32] selection:text-white">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {mascotas.map((mascota) => (
                  <div
                    key={mascota.id}
                    className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-all flex flex-col justify-between"
                  >
                    <div>
                      <div className="w-full h-52 p-4 bg-[#fff8f5] dark:bg-[#1a0f08] flex items-center justify-center border-b border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 overflow-hidden">
                        <img
                      ...
                      <div className="p-5">
                        <div className="flex items-center justify-between gap-2 mb-2">
                          ...
                          <span className="px-2.5 py-0.5 rounded-full bg-[#fff1ea] dark:bg-[#3f2c20] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 text-[#6c2f00] dark:text-[#ffdbc9] text-xs font-semibold">
                    ...
                    <div className="px-5 py-3 border-t border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 bg-[#fff8f5]/50 dark:bg-[#1a0f08]/50 flex items-center justify-between text-[11px] text-[#54433a] dark:text-[#dac2b6]">
      ...
      {mascotaSeleccionada && (
        <div className="fixed inset-0 z-50 bg-[#28180d]/60 dark:bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative font-body-editorial max-h-[90vh] overflow-y-auto">
            <button
            ...
            <div className="w-full h-56 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-2xl overflow-hidden p-3 border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 mb-4 flex items-center justify-center">
              <img
            ...
            <div className="bg-[#fff8f5] dark:bg-[#1a0f08] p-4 rounded-2xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 mb-6">

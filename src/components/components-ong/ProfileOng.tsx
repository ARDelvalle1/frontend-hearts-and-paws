...
const ProfileOng = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-3xl p-6 sm:p-8 shadow-xs font-body-editorial transition-colors">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-2xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 mb-6">
        <img
          src={avatarUrl}
        ...
        <div className="flex-1 text-center sm:text-left min-w-0">
          ...
          {ong.plan && (
            <span className="inline-flex items-center gap-1.5 bg-[#fff1ea] dark:bg-[#3f2c20] text-[#6c2f00] dark:text-[#ffdbc9] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 text-xs font-semibold px-3 py-1 rounded-full mt-3">
      ...
      {ong.descripcion && (
        <div className="mb-6">
          ...
          <p className="text-xs sm:text-sm text-[#54433a] dark:text-[#dac2b6] leading-relaxed bg-[#fff8f5] dark:bg-[#1a0f08] p-4 rounded-2xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 whitespace-pre-line">
            {ong.descripcion}
          </p>
        </div>
      )}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
          <div className="flex items-center gap-3 p-3.5 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10">
            ...
            <div className="min-w-0">
              ...
              <p className="font-semibold text-[#28180d] dark:text-[#ffede4] truncate">{ong.telefono || "No especificado"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3.5 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10">
            ...
            <div className="min-w-0">
              ...
              <p className="font-semibold text-[#28180d] dark:text-[#ffede4] truncate">{ong.direccion || "No especificada"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3.5 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10">
            ...
            <div className="min-w-0">
              ...
              <p className="font-semibold text-[#28180d] dark:text-[#ffede4] truncate">{ong.ciudad || "No especificada"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3.5 bg-[#fff8f5] dark:bg-[#1a0f08] rounded-xl border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10">
            ...
            <div className="min-w-0">
              ...
              <p className="font-semibold text-[#28180d] dark:text-[#ffede4] truncate">{ong.pais || "No especificado"}</p>
            </div>
          </div>
        </div>
      </div>

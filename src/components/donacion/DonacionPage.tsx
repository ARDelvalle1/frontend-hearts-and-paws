  ...
  return (
    <div className="min-h-screen bg-[#fff8f5] dark:bg-[#1a0f08] text-[#28180d] dark:text-[#ffede4] font-body-editorial flex flex-col selection:bg-[#c85a32] selection:text-white">
      <div className="flex-grow max-w-[1280px] mx-auto px-6 md:px-12 py-12 w-full">
        ...
        {/* Panel de Filtros */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-lg mx-auto mb-12 bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 p-3 rounded-full shadow-xs">
          <div className="relative w-full sm:flex-1">
            ...
            >
              <option value="" className="bg-white dark:bg-[#28180d] text-[#6c2f00] dark:text-[#ffdbc9]">Todas las especies</option>
          ...
          <div className="relative w-full sm:flex-1">
            ...
            >
              <option value="mas_reciente" className="bg-white dark:bg-[#28180d] text-[#6c2f00] dark:text-[#ffdbc9]">Más recientes primero</option>
              <option value="mas_antiguo" className="bg-white dark:bg-[#28180d] text-[#6c2f00] dark:text-[#ffdbc9]">Más antiguos primero</option>
            </select>
            <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-[#6c2f00] dark:text-[#ffdbc9] pointer-events-none text-xl">
              expand_more
            </span>
        ...
        {!cargando && !error && resultados.length === 0 && (
          <div className="bg-white dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-3xl p-12 text-center max-w-md mx-auto my-8 shadow-xs font-body-editorial">

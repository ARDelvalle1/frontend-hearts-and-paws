...
export default function DonacionCard({ donacion }: DonacionCardProps) {
  ...
  const colorEstadoPago: Record<string, string> = {
    ...
    pending: 'bg-[#ffeade] dark:bg-[#3f2c20] text-[#6c2f00] dark:text-[#ffdbc9] border border-[#6c2f00]/20 dark:border-[#ffdbc9]/20',
  ...
  return (
    <div className="relative bg-[#fff1ea] dark:bg-[#28180d] border border-[#6c2f00]/15 dark:border-[#ffdbc9]/15 rounded-xl shadow-none p-6 md:pr-32 flex flex-col md:flex-row gap-6 transition-all duration-300 hover:border-[#6c2f00]/30 font-body-editorial">
      {/* Badge flotante */}
      <div
      ...
      <div className="w-full md:w-36 h-36 flex items-center justify-center bg-[#fff8f5] dark:bg-[#3f2c20] border border-[#6c2f00]/10 dark:border-[#ffdbc9]/10 rounded-lg overflow-hidden relative flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <p className="text-[#28180d] dark:text-[#ffede4] font-medium text-sm mt-1">

      ...
      <main className="flex-grow">
        ...
        <section className="py-24 md:py-32 px-6 md:px-12 max-w-[1280px] mx-auto text-center">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            <span className="material-symbols-outlined text-[#6c2f00] dark:text-[#ffdbc9] text-4xl mb-6 opacity-80">
              volunteer_activism
            </span>
        ...
        <section id="historias" className="pb-24 px-6 md:px-12 max-w-[1280px] mx-auto w-full">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#6c2f00]/15 dark:border-[#ffdbc9]/20 bg-[#fff1ea] dark:bg-[#241810] shadow-md hover:shadow-lg transition-all duration-500">
            <div key={currentStory.id} className="grid grid-cols-1 lg:grid-cols-12 min-h-[480px] transition-all duration-500 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="lg:col-span-7 p-6 sm:p-8 lg:p-10 flex flex-col justify-between z-10">
                <div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                    <div className="flex items-center gap-2 bg-[#6c2f00]/10 dark:bg-[#ffdbc9]/10 px-3.5 py-1.5 rounded-full text-[#6c2f00] dark:text-[#ffdbc9] font-body-editorial text-xs font-bold shadow-xs">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="bg-[#6c2f00]/10 dark:bg-[#ffdbc9]/10 text-[#6c2f00] dark:text-[#ffdbc9] px-3 py-1 rounded-full font-body-editorial text-xs font-semibold">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="p-4 rounded-xl bg-[#2e5d32]/10 dark:bg-[#2e5d32]/25 border border-[#2e5d32]/20 dark:border-[#2e5d32]/40 shadow-xs hover:border-[#2e5d32]/40 dark:hover:border-[#2e5d32]/60 transition-colors">
                      ...
                      <p className="font-body-editorial text-sm sm:text-base text-[#28180d] dark:text-[#e8f5e9] font-medium leading-relaxed">
                        {currentStory.result}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#6c2f00]/10 dark:border-[#ffdbc9]/15">
              ...
              <div className="lg:col-span-5 relative min-h-[300px] lg:min-h-full overflow-hidden bg-[#6c2f00]/5 dark:bg-[#ffdbc9]/5 group">
                <Image

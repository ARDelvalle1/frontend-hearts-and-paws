    ...
    <footer className="bg-[#fbddca] dark:bg-[#0d0d0f] w-full py-12 px-6 md:px-12 border-t border-[#dac2b6]/40 dark:border-[#ffdbc9]/15 font-body-editorial text-[#1c1c21] dark:text-[#ffede4]">
      <div className="flex flex-col md:flex-row justify-between items-center max-w-[1280px] mx-auto gap-8">
        ...
        <nav className="flex flex-wrap justify-center gap-6 font-body-editorial text-sm font-semibold text-[#54433a] dark:text-[#dac2b6]">
          <a href="/adoptar/adopcion" className="hover:text-[#6c2f00] dark:hover:text-[#ffdbc9] transition-colors">Adopciones</a>
          <a href="/donacion" className="hover:text-[#6c2f00] dark:hover:text-[#ffdbc9] transition-colors">Donaciones</a>
          <Link href="/register" className="hover:text-[#6c2f00] dark:hover:text-[#ffdbc9] transition-colors">Registro</Link>
          <a href="/login" className="hover:text-[#6c2f00] dark:hover:text-[#ffdbc9] transition-colors">Iniciar sesión</a>
        </nav>
